...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    controller.managedObjectController = self.managedObjectController;
    return YES;
}
...
-(ManagedObjectController*)managedObjectController {
    if (_managedObjectController != nil)
        return _managedObjectController;
    _managedObjectController = [[ManagedObjectController alloc] init];
    return _managedObjectController;
}
